...
const content: CaseStudy[] = [
  ...
  },
  {
    ...
    article: {
      ...
      ar: "نظام تخليص الفواتير الإلكترونية اللحظي المتوافق مع هيئة الزكاة والضريبة والجمارك (ZATCA). يتيح النظام الربط المباشر، الختم التشفيري، وإصدار شهادات CCSID بكل سهولة وفعالية.",
    },
    faq: [
      {
        q: {
