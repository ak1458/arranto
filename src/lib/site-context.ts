...
export function siteContext(): string {
  ...
  return `## Studio
Arranto is a founder-led, AI-native software studio. Founded 2017 in Gonda, India, as Smile Fotilo; rebranded to Arranto. One engineer. 10+ delivered projects. 118 verified Google reviews. Tagline: "Start to running. Nothing left undone."
Pages: / (home), /work (case studies), /studio (about), /contact.
Free legacy tools live on smilefotilo.com (external site).
