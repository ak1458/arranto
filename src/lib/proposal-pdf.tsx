...
const L = {
  ...
  ar: {
    ...
    overviewBody: (t: string, who: string) =>
      `يستكشف ${who} مشروع ${t} مع أرانتو، استوديو برمجيات يقوده مؤسسه — تأسس 2017، أكثر من 20 مشروعًا مُسلّمًا، 118 تقييمًا موثّقًا على جوجل. يلخص هذا العرض ما نوقش مع مساعد الاستوديو`,
